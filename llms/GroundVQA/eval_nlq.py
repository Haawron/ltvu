...
class ReferringRecall(object):
    ...
    def evaluate(self, predictions, verbose=True, return_ious=False):
        ...
        for pred_datum in predictions:
            ...
            query_idx = pred_datum["query_idx"]
            gt_datum = self.gt_dict[key]
            gt_query_datum = gt_datum["language_queries"][query_idx]
            ...
            all_ious[f'{pred_datum["annotation_uid"]}_{query_idx}'] = overlap
        ...
        if return_ious:
            return mean_results, score_str, all_ious
        else:
